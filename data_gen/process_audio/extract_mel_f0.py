...
'''
提取音频梅尔语谱图以及音频的F0特征（基频等值线特征，也可以理解为音高特征）
'''
...
if __name__ == '__main__':
    ...
    wav_16k_name = os.path.join(main_path, f"data/processed/videos/{person_id}/aud.wav")
    out_name = os.path.join(main_path, f"data/processed/videos/{person_id}/aud_mel_f0.npy")
