...
def extract_wav16k_job(audio_name:str):
    out_path = audio_name.replace("/aac","/audio").replace(".m4a", ".wav")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--aud_dir", default=os.path.join(root_path, 'data/raw/aac/'))
    ...
    if ds_name in ['CMLR']:
        aud_name_pattern = os.path.join(aud_dir, "*/*/*.m4a")
